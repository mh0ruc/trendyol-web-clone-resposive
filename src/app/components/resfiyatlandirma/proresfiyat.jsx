...
import RrEsIlanEkstralarContainer from "./resextra";

const ResPro = () => {
  const [proOzellikler, setProOzellikler] = useState([
    { id: 1, name: "ozellik 1" },
    { id: 2, name: "ozellik 2" },
    { id: 3, name: "ozellik 3" },
  ]);
  ...
  return (
    <div>
      <div className="shadow h-full mt-5 max-h-[500px] mb-16 w-full max-w-[350px]">
        ...
        >
          <span>Pro paket fiyatlandırma</span>
          <span className="text-xl">{proDropdownOpen ? "↓" : "→"}</span>
        </div>

        {proDropdownOpen && (
          <div className="max-h-[500px]  overflow-auto bg-gray-100 p-2 mt-4">
            <h2 className="text-xl font-semibold">Pro Paket</h2>

            <div className="bg-white w-full p-4 mt-4 shadow overflow-hidden">
              <div className="shadow mb-4">
                <textarea name="" id="" className=" h-24 p-2 border"></textarea>
              </div>
